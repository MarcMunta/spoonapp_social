...
document.getElementById("searchFriendInput")?.addEventListener("input", function () {
      ...
      users.forEach(user => {
        ...
        li.innerHTML = `
                    <div class="user-suggestion">
                        <img src="${user.avatar || 'https://via.placeholder.com/40'}" alt="avatar" width="32" height="32" />
...
document.addEventListener('click', function (e) {
  const notificationItem = e.target.closest('.notification-item[data-notification-type="message"]');
...
document.querySelectorAll('#categoryTabs .nav-link').forEach(tab => {
  tab.addEventListener('click', function (e) {
    ...
    const activeGroup = document.querySelector(`.category-group[data-category="${selected}"]`);
